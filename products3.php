...
<ul style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif';font-size: 18px">
	...
	<li><a href="products.php">LAPTOP AND ACCESSORIES</a></li>
	<li><a href="products2.php">COMPUTER AND ACCESSORIES</a></li>  
	<li><a class="active" href="products3.php">NETWORKING</a></li>  
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <p>
                    Enjoy the same lowest prices as yourAAA Technologies </p>
